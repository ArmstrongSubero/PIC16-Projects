...
void servoRotate0()
{
  ...
  for(i=0;i<50;i++)
  {
    ...
    RD0 = 0;
    _delay((unsigned long)((19300)*(8000000/4000000.0)));
  }
}
# 48 "Servo.c"
void servoRotate90()
{
  ...
  {
    RD0 = 1;
    _delay((unsigned long)((1700)*(8000000/4000000.0)));
    RD0 = 0;
    _delay((unsigned long)((18300)*(8000000/4000000.0)));
  }
}
# 69 "Servo.c"
void servoRotate180()
{
  ...
  {
    RD0 = 1;
    _delay((unsigned long)((2600)*(8000000/4000000.0)));
    RD0 = 0;
    _delay((unsigned long)((17400)*(8000000/4000000.0)));
  }
}
