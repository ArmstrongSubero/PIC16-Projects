 ...
 * Program: TinyJoypad Driver Layer for Tiny Pacman
 * Compiler: XC8
 *
 ...
 *   Fire/Act  -> RA2 (to GND, internal pull-up)
 *   Down btn  -> RA4 (to GND, internal pull-up)
 *   Up btn    -> RA5 (to GND, internal pull-up)
...
#define BTN_UP_PORT     PORTAbits.RA5
...
#define JOY_up_pressed()      (BTN_UP_PORT == 0)
...
#define JOY_DLY_ms(x)  JOY_delay_ms(x)
...
/* Frame rate */
#define JOY_SLOWDOWN()  __delay_ms(20)
