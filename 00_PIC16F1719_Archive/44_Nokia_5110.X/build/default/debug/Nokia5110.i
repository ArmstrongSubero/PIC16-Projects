...
# 18 "Nokia5110.c" 2
# 27 "Nokia5110.c"
const char font[] = {0x00, 0x00, 0x00, 0x00, 0x00,
...
void LCD5110_init(void)
{
    ...
    LCD5110_send(0x20 + 0x01, 0);
    LCD5110_send(0x80 + 0x40, 0);
    LCD5110_send(0x04 + 0x02, 0);
    LCD5110_send(0x10 + 0x03, 0);
    LCD5110_send(0x20 + 0x00, 0);
    LCD5110_send(0x08 + 0x04, 0);
}
# 173 "Nokia5110.c"
void LCD5110_send(unsigned char data, unsigned char dc)
{
...
{
  LCD5110_send(0x80 | x, 0);
  LCD5110_send(0x40 | y, 0);
}
# 205 "Nokia5110.c"
void LCD5110_clearScreen(void)
{
...
void sitoa(char *buf, int value, int base){
...
void LCD5110_writeInteger(int v)
{
    ...
    LCD5110_sendString(sitoa(buf, v, 10));
}
# 329 "Nokia5110.c"
char LCD5110_drawBitmap(const unsigned char y[])
{
