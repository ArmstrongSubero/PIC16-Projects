...
void main(void) {
    ...
    float frequency, inductance_h, inductance_uh, inductance_mh;
    ...
    while (1)
    {
        ...
        if (frequency > 0) {
            ...
            if (inductance_uh > 999.0) {
                ...
                EUSART_Write_Float(inductance_mh, 3);
                EUSART_Write_Text("\n");
            } else {
                ...
                EUSART_Write_Float(inductance_uh, 2);
                EUSART_Write_Text("\n");
            }
        } else {
