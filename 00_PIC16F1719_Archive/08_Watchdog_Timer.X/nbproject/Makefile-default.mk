...
FINAL_IMAGE=${DISTDIR}/08_Watchdog_Timer.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/08_Watchdog_Timer.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
