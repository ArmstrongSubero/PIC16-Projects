...
FINAL_IMAGE=${DISTDIR}/16_NCO.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/16_NCO.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
