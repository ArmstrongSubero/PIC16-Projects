...
static void Step_Breathe(uint8_t reset)
{
    ...
    uint16_t duty = (x * x) / 255;
    (CCPR1L = (uint8_t)((uint8_t)duty));
...
static void Step_Heartbeat(uint8_t reset)
{
    ...
    switch (state)
    {
        case 0: duty += 18; if (duty >= 220) { duty = 220; state = 1; } break;
        case 1: duty -= 28; if (duty <= 60) { duty = 60; state = 2; } break;
        case 2: { duty = 40; state = 3; } break;
        case 3: duty += 20; if (duty >= 180) { duty = 180; state = 4; } break;
        case 4: duty -= 16; if (duty <= 0) { duty = 0; state = 5; } break;
        case 5: { duty = 0; state = 6; } break;
...
static void Step_Candle(uint8_t reset)
{
    ...
    uint8_t base = 90;
    uint8_t flick = (uint8_t)(lfsr & 0x3F);
    (CCPR1L = (uint8_t)((uint8_t)(base + flick)));
}
