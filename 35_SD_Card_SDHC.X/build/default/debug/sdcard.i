...
static __attribute__((inline)) void SD_Select(void) { LATCbits.LATC2 = 0; }
static __attribute__((inline)) void SD_Deselect(void) { LATCbits.LATC2 = 1; }


static __attribute__((inline)) void dbg(const char *s)
{
    EUSART_Write_Text((char*)s);
}


static __attribute__((inline)) uint8_t sd_xfer(uint8_t b)
{
...
static unsigned char sd_send_acmd41(uint32_t arg)
{
    ...
    r1 = sd_send_cmd(55, 0, 0xFF);
    if (r1 > 0x01) return r1;

    r1 = sd_send_cmd(41, arg, 0xFF);
    return r1;
}
...
void SDcard_init(void)
{
    ...
    dbg("Sending CMD8...");
    unsigned char r1 = sd_send_cmd(8, 0x000001AAUL, 0x87);
    if (r1 == 0x01)
    {
