...
# 10 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c99\\ctype.h" 3
int isalnum(int);
int isalpha(int);
int isblank(int);
int iscntrl(int);
...
int tolower(int);
int toupper(int);
# 48 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c99\\ctype.h" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c99\\bits/alltypes.h" 1 3
# 49 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c99\\ctype.h" 2 3
...
static uint8_t parse_u8(const char *s, uint8_t *out)
{
    if (!s || !*s) return 0;
    uint16_t v = 0;
    while (*s && (((unsigned char)(((unsigned char)*s)-'0')) < 10)) {
...
static uint8_t parse_hdop_x100(const char *s, uint16_t *out)
{
    ...
    if (*s == '.') {
        ...
        if (*s && (((unsigned char)(((unsigned char)*s)-'0')) < 10)) { frac = (uint16_t)(frac * 10 + (uint16_t)(*s - '0')); frac_scale *= 10; s++; }
        if (*s && (((unsigned char)(((unsigned char)*s)-'0')) < 10)) { frac = (uint16_t)(frac * 10 + (uint16_t)(*s - '0')); frac_scale *= 10; s++; }
    }
...
static volatile uint8_t gga_fixq = 0;
static volatile uint8_t gga_sats = 0;
static volatile uint16_t gga_hdop_x100 = 9999;
...
static uint8_t quality_ok(void)
{
    ...
    if (gga_sats < 6) return 0;
    if (gga_hdop_x100 > 250) return 0;
    return 1;
}
...
{
    int32_t lat_avg = (int32_t)(sum_lat / (int64_t)8);
    int32_t lon_avg = (int32_t)(sum_lon / (int64_t)8);
