 ...
 *                      SD cards. This library has a size limitation of 2 GB
 *                      which is a lot for embedded data logging and other things
 *                      you'll want to do with an embedded system. 
 * 
 ...
 *                       RB3.
 *                       
 * Created December 26th 2025, 4:11 PM
 */
