 ...
 * Program: Header file to setup PIC16F1717, specifically for sleep mode
 * Compiler: XC8 (v1.38, MPLAX X v3.40)
 * Program Version 2.1
 *                *Separated file into Header and C source file
 *                *Changed comments and layout
 *                *Changed BROWNOUT to accommodate sleep mode
 *                  
 ...
 * Last Modified: November 4th, 2016, 8:24 PM
 ******************************************************************************/
...
#pragma config BOREN = NSLEEP, BORV = LO, LPBOR = OFF      // Brown-out Reset Enabled (Disabled in sleep)
