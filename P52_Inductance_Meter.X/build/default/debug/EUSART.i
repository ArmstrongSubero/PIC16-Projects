...
{
    unsigned int x;
 x = (32000000 - baudrate*64)/(baudrate*64);
...
void EUSART_Write_Unsigned_Integer(uint32_t value_to_send) {
    char buffer[20];
    sprintf(buffer, "%lu", value_to_send);
    EUSART_Write_Text(buffer);
}
# 216 "EUSART.c"
void ftoa(char *buffer, float value, int precision) {
