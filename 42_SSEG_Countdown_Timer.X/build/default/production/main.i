...
void __attribute__((picinterrupt(("")))) isr(void)
{
    if(PIR1bits.TMR2IF)
    {
        ...
        switch(currentDigit)
        {
            case 0: LATBbits.LATB0 = 1; break;
            case 1: LATBbits.LATB1 = 1; break;
            case 2: LATBbits.LATB2 = 1; break;
            case 3: LATBbits.LATB3 = 1; break;
            default: break;
        }
...
void main(void)
{
    ...
    while(1)
    {
        _delay((unsigned long)((TICK_MS)*(32000000/4000.0)));
        ...
        if(hold_button_action(PORTAbits.RA1, &incBtn, TICK_MS))
        {
        ...
        if(hold_button_action(PORTAbits.RA2, &decBtn, TICK_MS))
        {
