...
static __attribute__((inline)) void PPS_Unlock(void)
{
    PPSLOCK = 0x55;
    PPSLOCK = 0xAA;
...
static __attribute__((inline)) void PPS_Lock(void)
{
    PPSLOCK = 0x55;
    PPSLOCK = 0xAA;
...
void CLC1_Init_OR_RA0_RA1_to_RB2(void)
{
    ...
    CLCIN0PPS = ( ((0) << 3) | ((0) & 0x07) );
    CLCIN1PPS = ( ((0) << 3) | ((1) & 0x07) );
