...
void Buzzer_Success(void)
{
    Buzzer_Beep(523, 50, 90);
    delay_variable_ms(40);
    Buzzer_Beep(659, 50, 90);
    delay_variable_ms(40);
    Buzzer_Beep(784, 60, 160);
}
...
void Buzzer_Failure(void)
{
    Buzzer_Beep(784, 60, 160);
    delay_variable_ms(40);
    Buzzer_Beep(659, 60, 220);
}

void Buzzer_Warning(void)
{
    for(uint8_t i = 0; i < 3; i++) {
        Buzzer_Beep(880, 60, 90);
...
void Buzzer_Alert(void)
{
    for(uint8_t i = 0; i < 5; i++) {
        Buzzer_Beep(880, 75, 50);
        delay_variable_ms(50);
    }
}

void Buzzer_KeyPress(void) { Buzzer_Beep(523, 35, 40); }
void Buzzer_MenuSelect(void) { Buzzer_Beep(659, 40, 70); }
void Buzzer_MenuBack(void) { Buzzer_Beep(523, 40, 70); }

void Buzzer_PowerUp(void)
{
    Buzzer_Beep(523, 55, 80); delay_variable_ms(40);
    Buzzer_Beep(659, 55, 80); delay_variable_ms(40);
    Buzzer_Beep(784, 55, 80); delay_variable_ms(40);
    Buzzer_Beep(1047, 60, 150);
}

void Buzzer_PowerDown(void)
{
    Buzzer_Beep(1047, 55, 80); delay_variable_ms(40);
    Buzzer_Beep(784, 55, 80); delay_variable_ms(40);
    Buzzer_Beep(659, 55, 80); delay_variable_ms(40);
    Buzzer_Beep(523, 60, 150);
}

void Buzzer_CriticalBattery(void)
{
    for(uint8_t i = 0; i < 2; i++) {
        Buzzer_Beep(392, 75, 280);
...
{
    for(uint8_t i = 0; i < 2; i++) {
        Buzzer_Beep(988, 75, 180);
        delay_variable_ms(90);
    }
    Buzzer_Beep(988, 75, 360);
}
