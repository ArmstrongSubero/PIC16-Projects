...
void main(void) {
    ...
    PWM_Init(PWM_CCP1, PWM_TIMER6, 31250);
    PWM_Init(PWM_CCP2, PWM_TIMER6, 31250);


    PWM_SetOutputPin(PWM_CCP1, &RB0PPS);
    PWM_SetOutputPin(PWM_CCP2, &RB1PPS);


    PWM_SetDutyCycle(PWM_CCP1, 75);
    PWM_SetDutyCycle(PWM_CCP2, 50);
