...
static volatile uint16_t g_pulse_us = ((500u + 2500u) / 2u);
static volatile uint8_t g_rb_mask = 0x01;
static volatile _Bool g_pin_high = 0;

static __attribute__((inline)) void delay_ms(uint16_t ms)
{
    while (ms--)
    {
...
static __attribute__((inline)) uint32_t q15_mul(uint32_t a, uint32_t b)
{
    return (uint32_t)(((uint64_t)a * (uint64_t)b + (1u << 14)) >> 15);
}


static __attribute__((inline)) uint32_t scurve5_q15(uint32_t t)
{
...
static __attribute__((inline)) uint16_t deg_to_us(uint16_t deg)
{
    if (deg < 5u) deg = 5u;
    if (deg > 175u) deg = 175u;

    uint32_t span = (uint32_t)(2500u - 500u);
    return (uint16_t)(500u + (span * deg) / 180u);
}


static __attribute__((inline)) void schedule_after_us(uint16_t delta_us)
{
...
static uint16_t current_deg_from_pulse(void)
{
    ...
    uint32_t span = (uint32_t)(2500u - 500u);
    return (uint16_t)(((uint32_t)(us - 500u) * 180u) / span);
}
...
void servo_sweep_deg_scurve(uint16_t start_deg, uint16_t end_deg, uint32_t duration_ms, uint16_t tick_ms)
{
    ...
    {
        uint32_t t_q15 = (uint32_t)((uint64_t)32768u * k / steps);
        uint32_t s_q15 = scurve5_q15(t_q15);

        int32_t delta = (int32_t)(((int64_t)diff * (int64_t)s_q15 + (32768u >> 1)) >> 15);
...
void servo_isr(void)
{
    ...
    if (g_pin_high)
    {
        ...
        uint16_t off_us = (uint16_t)(20000u - g_pulse_us);
...
void main(void)
{
    ...
    while (1)
    {
        servo_sweep_deg_scurve(0, 180, 2000, 10); _delay((unsigned long)((300)*(32000000/4000.0)));
        servo_sweep_deg_scurve(180, 0, 2000, 10); _delay((unsigned long)((300)*(32000000/4000.0)));

        servo_sweep_deg_scurve(0, 180, 600, 8); _delay((unsigned long)((200)*(32000000/4000.0)));
        servo_sweep_deg_scurve(180, 0, 600, 8); _delay((unsigned long)((200)*(32000000/4000.0)));
    }
}
