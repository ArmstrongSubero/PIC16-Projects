...
# 24 "main.c" 2
# 76 "main.c"
static __attribute__((inline)) void CE_H(void){ LATCbits.LATC0 = 1; }
static __attribute__((inline)) void CE_L(void){ LATCbits.LATC0 = 0; }
static __attribute__((inline)) void CSN_H(void){ LATCbits.LATC1 = 1; }
static __attribute__((inline)) void CSN_L(void){ LATCbits.LATC1 = 0; }
# 88 "main.c"
...
static __attribute__((inline)) uint8_t spi_xfer(uint8_t b){ return SPI_Exchange8bit(b); }


static __attribute__((inline)) void toggleCSN(void)
{
    CSN_H(); _delay((unsigned long)((20)*(32000000/4000000.0)));
    CSN_L(); _delay((unsigned long)((10)*(32000000/4000000.0)));
}
...
{
    nrf_write_reg(0x07, 0x40 | 0x20 | 0x10);
}
...
static void nrf_read_payload(uint8_t *buf, uint8_t len)
{
    CSN_L();
    spi_xfer(0x61);
    for(uint8_t i=0;i<len;i++) buf[i] = spi_xfer(0xFF);
    CSN_H();
}
...
static void radio_common_setup(void)
{
    ...
    nrf_write_reg(0x05, 83);
    nrf_write_reg(0x06, 0x06);


    nrf_write_buf(0x0A, adr0, 5);
    nrf_write_buf(0x10, adr0, 5);


    nrf_write_reg(0x11, (uint8_t)5);
}
...
static void radio_init_tx(void)
{
    ...
    nrf_write_reg(0x00, (0x02 | 0x08 | 0x04));
    _delay((unsigned long)((3)*(32000000/4000.0)));
...
static void radio_init_rx(void)
{
    ...
    nrf_write_reg(0x00, (0x02 | 0x08 | 0x04 | 0x01));
    _delay((unsigned long)((3)*(32000000/4000.0)));
...
static uint8_t tx_send_packet(const uint8_t *payload5)
{
    ...
    {
        uint8_t st = nrf_read_reg(0x07);
        if(st & 0x20)
        {
            nrf_write_reg(0x07, 0x20);
            return 1;
        }
        if(st & 0x10)
        {
...
static void initMain(void)
{
    ...
    ANSELCbits.ANSC3 = 0; TRISCbits.TRISC3 = 0;
    ANSELCbits.ANSC4 = 0; TRISCbits.TRISC4 = 1;
    ANSELCbits.ANSC5 = 0; TRISCbits.TRISC5 = 0;
...
void main(void)
{
    ...
    EUSART_Write_Integer(83);
    uart_print("  PL=");
    EUSART_Write_Integer(5);
    uart_crlf();
