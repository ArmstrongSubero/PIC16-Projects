...
uint16_t ADC_Read_Averaged(adc_channel_t channel, uint8_t samples)
{
    ...
    for (uint8_t i = 0; i < samples; i++)
    {
        ...
        if (i < samples - 1) _delay((unsigned long)((5)*(32000000/4000000.0)));
    }
...
void Joystick_Read(joystick_t *joy)
{
    ...
    joy->x = (int16_t)joy->raw_x - 512;
    joy->y = (int16_t)joy->raw_y - 512;


    joy->button = (PORTBbits.RB0 == 0) ? 1 : 0;
...
const char* Joystick_DirectionString(uint8_t direction)
{
    switch(direction)
    {
        ...
        case (0x01 | 0x04): return "UP-LEFT ";
        case (0x01 | 0x08): return "UP-RIGHT";
        case (0x02 | 0x04): return "DN-LEFT ";
        case (0x02 | 0x08): return "DN-RIGHT";
