...
FINAL_IMAGE=${DISTDIR}/36_Photoresistor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/36_Photoresistor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
