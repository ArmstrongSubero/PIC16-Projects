 ...
 * Program: 44_Nokia_5110
 * Compiler: XC8 (v2.45, MPLAX X v6.15)
 * Program Version: 1.0     
 *                
 * Program Description: This Program Allows PIC16F1719 to interface to a Nokia
 *                      5110 LCD module
 *                      
 *           
 * Hardware Description: A Nokia 5110 LCD is connected via a logic level Converter
 *                       as follows:
 *                        
 *                       Vcc  --> Vdd
 *                       Gnd  --> Vss
 ...
 * Updated March 26th, 2024 3:18 PM
 */
