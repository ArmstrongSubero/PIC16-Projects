...
# 16 "EEPROM_24AA512.c" 2
# 27 "EEPROM_24AA512.c"
static uint8_t EEPROM24AA512_Ctrl(_Bool read)
{
...
I2C_Status_t EEPROM24AA512_AckPoll(void)
{
    ...
    {
        I2C_Start();
        I2C_Status_t st = I2C_WriteByte(EEPROM24AA512_Ctrl(0));
        I2C_Stop();
...
I2C_Status_t EEPROM24AA512_WriteByte(uint16_t addr, uint8_t data)
{
    ...
    if ((st = I2C_WriteByte(EEPROM24AA512_Ctrl(0))) != I2C_OK) goto stop;
...
I2C_Status_t EEPROM24AA512_ReadByte(uint16_t addr, uint8_t *data)
{
    ...
    if ((st = I2C_WriteByte(EEPROM24AA512_Ctrl(1))) != I2C_OK) goto stop;
...
I2C_Status_t EEPROM24AA512_WritePage(uint16_t addr, const uint8_t *data, uint8_t len)
{
    ...
    uint8_t offset = addr & (128 - 1);
    uint8_t room = 128 - offset;
