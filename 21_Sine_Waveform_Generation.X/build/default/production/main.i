...
void generateSineTable(uint8_t amplitude, uint8_t offset)
{
    ...
    {
        float sine_val = sinf(i * 2.0 * 3.14159265358979323846 / 256);
...
uint16_t calculate_sample_delay(sine_config_t* config)
{
    ...
    samples_per_cycle = 256 / config->table_skip;
...
void main(void)
{
    ...
    my_sine.frequency_hz = 1000;
    my_sine.amplitude = 127;
    my_sine.dc_offset = 128;
    my_sine.table_skip = 4;
# 240 "main.c"
