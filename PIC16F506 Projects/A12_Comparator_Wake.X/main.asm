...
START
    ...
    goto    flash		    ; flash LED else to next instruction
    ...
    movlw   b'00111010'
	    ...
	    ; ----1----	    ; turn comparator ON
	    ; -----0---	    ; -ref is 0.6 v
	    ; -------1-	    ; +ref is CIN+
	    ; --------0	    ; enable wake on comparator change

    movwf   CM1CON0	    ; move to CM1CON reg

    btfsc   CM1CON0, C1OUT	    ; if comparator output high
    bsf	    PORTC, 3		    ;   set bit
    btfss   CM1CON0, C1OUT	    ; if comparator output low
    bcf	    PORTC, 3		    ;	clear bit
     
    movlw   .1			    ; delay 10 ms to allow comparator to settle
    pagesel delay10
    call    delay10
