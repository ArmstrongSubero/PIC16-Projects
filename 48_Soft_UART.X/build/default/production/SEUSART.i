...
# 15 "SEUSART.c" 2
# 31 "SEUSART.c"
static __attribute__((inline)) unsigned char SUART_Lock(void)
{
...
static __attribute__((inline)) void SUART_Unlock(unsigned char gie)
{
...
unsigned char SUART_Receive(void)
{
    ...
    _delay((unsigned long)(((1000000UL/2400) / 2)*(32000000/4000000.0)));
    ...
    _delay((unsigned long)(((1000000UL/2400))*(32000000/4000000.0)));
...
void SUART_Transmit(const char DataValue)
{
    ...
    for (unsigned char i = 0; i < 8; i++)
    {
        LATBbits.LATB1 = ((DataValue >> i) & 0x1) ? 1 : 0;
        _delay((unsigned long)(((1000000UL/2400))*(32000000/4000000.0)));
    }
